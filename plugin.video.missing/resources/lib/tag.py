...
class ECTag:
    ...
    def assertself(self):
        ...
        assert self.tagname in list(codes.tags.keys())
        assert self.tagtype in list(codes.tagtypes.keys())
    ...
    def debugrepr (self, indent_level=0 ):
        ...
        result += ( self._tagname_debugrepr())
        result += ( self._tagtype_debugrepr())
        ...
        result +=  (self._tagdata_debugrepr())
        result += "\n"
    ...
    def _tagdata_debugrepr(self):
        ...
        if self.tagtype == 'string':
            return "tagdata: %s " % str.encode(self.tagdata, "utf-8")
        else:
